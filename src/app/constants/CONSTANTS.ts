export class CONSTANTS {
  ...
  public static PAGE_SIZE_CRU_VIEW = 10;
  public static isOpen = false;
}


export class TYPE_CONFIG {
  public static KHN = 'KHN';
  public static CTT = 'CTT';
  public static BCTTĐ = 'BCTTÐ';
  public static KLTT = 'KLTT';
  public static QDHDTD = 'QDHDTD';
  public static QDHDGS = 'QDHDGS';
  public static KHTH = 'KHTH';
  public static UDT = 'UDT';
  public static CHDHS = 'CHDHS';
}
